...
const objectives = [
  ...
  },
  {
    ...
    text: 'Implement a Smart Belt Monitoring system that replaces reactive and fixed-interval maintenance with continuous, data-driven surveillance. An ESP32 microcontroller connected to temperature, vibration, and Hall-effect RPM sensors streams live readings to a Flask backend, where a Random Forest model classifies belt condition in real-time into Normal, Warning, or Critical states. The model simultaneously estimates Remaining Useful Life (RUL) — how many operating hours remain before failure — and assigns a risk level of Low, Medium, High, or Failed. A hybrid decision engine combines ML predictions with rule-based threshold checks to ensure both fast response for obvious faults and accurate pattern-based detection for gradual degradation. Alerts are pushed to the mobile app immediately, giving maintenance teams time to act before any unplanned production stoppage occurs.',
  },
  {
    num: '3',
  ...
  return (
    <div style={{ width: '100%', overflowX: 'auto', paddingBottom: '0.5rem' }}>
      <svg viewBox="0 0 960 600" xmlns="http://www.w3.org/2000/svg" style={{ width: '100%', minWidth: 680, display: 'block' }}>
        ...
        <text x="721" y="75" fill="#fde68a" fontSize="9">• ESP32 + Temp + Vibration + RPM sensors</text>
        <text x="721" y="91" fill="#fde68a" fontSize="9">• Random Forest multi-class classifier</text>
        <text x="721" y="107" fill="#fde68a" fontSize="9">• Status: Normal / Warning / Critical</text>
        <text x="721" y="123" fill="#fde68a" fontSize="9">• Remaining Useful Life (RUL) estimation</text>
        <text x="721" y="139" fill="#fde68a" fontSize="9">• Risk: Low / Medium / High / Failed</text>
        <text x="721" y="155" fill="#fde68a" fontSize="9">• Hybrid: rule-based + ML decisions</text>
          ...
          <div className="dom-prob-grid" style={{ display:'flex', flexDirection:'column', gap:'1rem' }}>
            <motion.div className="dom-problem-box" {...inView(.06)}>
              ...
              <div style={{ lineHeight:1.8, fontSize:14, color:'#a1a1aa' }}>
                ...
                <br /><br />
                <strong style={{ color:'#6ee7b7' }}>① Inaccurate Manual Yield Tracking</strong> — Factories use paper records and mechanical scales with no digital traceability. Managers only discover whether a batch performed well after the full 6–8 hour processing cycle is complete — far too late for corrective action. There is no link between individual farmer deliveries and batch outcomes.
                <br /><br />
            ...
            <motion.div className="dom-solution-box" {...inView(.12)}>
              ...
              <div style={{ lineHeight:1.8, fontSize:14, color:'#a1a1aa' }}>
                ...
                <br /><br />
                <strong style={{ color:'#6ee7b7' }}>① Yield Prediction &amp; Traceability</strong> — Automated IoT weighing at leaf intake and powder output, a Gradient Boosting model predicting yield before processing completes, full digital traceability per farmer per batch, and a cause-specific recommendation engine that explains batch deviations in plain language.
                <br /><br />
                <strong style={{ color:'#6ee7b7' }}>② Smart Belt Monitoring</strong> — Real-time ESP32 sensor streams (temperature, vibration, RPM) analysed by a Random Forest model that classifies belt health, estimates Remaining Useful Life, and pushes alerts to maintenance staff before failures occur.
                <br /><br />
            ...
            <div style={{ display:'grid', gridTemplateColumns:'repeat(auto-fit,minmax(250px,1fr))', gap:'0.75rem' }}>
              {[
                ...
                },
                {
                  ...
                  points:[
                    'ESP32 + Temperature + Vibration + Hall-effect RPM',
                    'Random Forest multi-class condition classifier',
                    'Output: Normal / Warning / Critical belt status',
                    'Remaining Useful Life (RUL) continuous estimation',
                    'Risk level: Low / Medium / High / Failed',
                    'Hybrid: rule-based thresholds + ML pattern detection',
                    'Real-time Firestore sync → mobile push notification',
                    'Continuous 24/7 monitoring — zero manual intervention',
                  ],
                },
                {
                  label:'③ Disease AI',
